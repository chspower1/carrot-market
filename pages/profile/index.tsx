        ...
        <div className="py-10 px-4">
            ...
            <div className="mt-10 flex justify-around">
                <div className="flex flex-col items-center">
                    <div className="w-14 aspect-square text-white rounded-full bg-orange-500 flex justify-center items-center">
                        <svg
                            className="w-6 h-6"
                            fill="none"
                            stroke="currentColor"
            ...
            <div className="mt-12">
                <div className="flex items-center space-x-2">
                    <div className="w-12 aspect-square rounded-full bg-orange-400" />
                    <div>
                        <h4>니꼬</h4>
