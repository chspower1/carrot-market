        ...
        <div className="mt-16 px-4">
            ...
            <div className="mt-8">
                <div className="flex flex-col items-center">
                    <h5 className="text-gray-500 text-sm font-bold">Enter using:</h5>
                    {/* Select Email or Phone */}
                    <div className="grid border-b grid-cols-2 gap-16 mt-8 w-full ">
                        <button
                            className={cls(
                                "pb-4 border-b-2 hover:text-orange-300 ",
                                method === "email"
                                    ? "text-orange-400  border-b-orange-400 font-bold"
                ...
                {/*  */}
                <form className="flex flex-col mt-8 relative ">
                    ...
                    <button
                        className="bg-orange-500 hover:bg-orange-600 rounded-lg p-2.5 text-white mt-2 text-sm
                ...
                <div className="mt-8">
                    <div className="relative">
                        <div className="absolute w-full border-t-2" />
                        <div className="relative -top-3 text-center">
                            <span className="bg-white p-3 text-gray-500 text-sm">
                                Or enter with
                            </span>
                        </div>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                        <button className="flex justify-center items-center py-2 bg-white border shadow-md rounded-lg text-gray-400 hover:bg-gray-100 hover:text-gray-600 hover:shadow-inner transition-all ">
                            <svg
                                className="w-5 h-5"
                                aria-hidden="true"
                                fill="currentColor"
